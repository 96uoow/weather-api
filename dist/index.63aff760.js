...
const monthNum = function() {
    if (date.getMonth() < 10) return `0${date.getMonth() + 1}`;
...
async function request() {
    const { data  } = await (0, _axiosDefault.default)({
        url: "https://apis.data.go.kr/1360000/VilageFcstInfoService_2.0/getUltraSrtNcst?serviceKey" + key + `pageNo=1&numOfRows=1000&dataType=JSON&base_date=${now}&base_time=0600&nx=${nowNx}&ny=${nowNy}`,
        method: "GET"
    }).catch((error)=>{
        console.log(error);
    });
...
function dataToWindDirection(windData) {
    const Wvalue = Math.floor((windData + 11.25) / 22.5);
    switch(Wvalue){
        case 0:
            return "북(N)";
        case 1:
...
var Buffer = require("5afc9eb5983e5fd").Buffer;
"use strict";
/**
...
},{"5afc9eb5983e5fd":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("ab254f2a013f0998");
var ieee754 = require("10d2c280988bfcaa");
...
},{"ab254f2a013f0998":"eIiSV","10d2c280988bfcaa":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["9ZIyz","adjPd"], "adjPd", "parcelRequirecc0a")
